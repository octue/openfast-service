...
latex_documents = [
    ("index", "openfast_service.tex", u"openfast_service", u"OST Aerosense", "manual"),
]
...
man_pages = [("index", "openfast_service", u"openfast_service", [u"OST Aerosense"], 1)]
